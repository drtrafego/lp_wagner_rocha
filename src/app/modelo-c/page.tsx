...
export default function ModeloC() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div>
            <ScrollReveal type="up">
              <div className="flex items-center gap-3 mb-8">
                ...
                <span className="text-borde text-xs font-body uppercase tracking-[0.2em]">Advocacia Trabalhista — Cuiabá/MT</span>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal type="up" delay={0.1}>
              <h1 className="font-display font-extrabold text-chumbo leading-[1.05] mb-6" style={{ fontFamily: 'Archivo, sans-serif', fontSize: 'clamp(2rem, 5vw, 3.5rem)' }}>
                ...
                <em className="not-italic text-borde">Descubra o que você tem direito a buscar.</em>
              </h1>
            </ScrollReveal>
            ...
            {/* STATS ANIMADOS */}
            <ScrollReveal type="up" delay={0.3}>
            ...
            <ScrollReveal type="up" delay={0.35}>
              <a
                href="#formulario"
          ...
          <ScrollReveal type="scale" delay={0.15}>
            <div id="formulario" className="bg-white rounded-2xl shadow-xl shadow-chumbo/10 p-8 border border-chumbo/5 sticky top-24">
              ...
              <ContactForm variant="light" modelo="c" />
            </div>
          </ScrollReveal>
        </div>
      </section>
